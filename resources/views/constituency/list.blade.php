                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                        {{-- <a class="btn btn-xs btn-info"
                                                             ...
                                                             --}}
                                                            <a class="btn btn-xs btn-danger" href="{{route('consti.delete',['id'=>@$att->constituencyID])}}" onclick="return confirm('Are you sure , you want to delete this attachment ? ')"><i class="fa fa-trash"></i>
                                                                Delete
                                                            </a>
                                        </td>
                                    </tr>
        ...
        <div class="modal-body">
            <form method="get" action="{{route('constituency.store')}}">@csrf
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" name="constituencyName" aria-describedby="emailHelp" placeholder="Constituency Name">

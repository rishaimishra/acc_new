                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                        {{-- <a class="btn btn-xs btn-info"
                                                             ...
                                                             --}}
                                                            <a class="btn btn-xs btn-danger" href="{{route('embasy.delete',['id'=>@$att->embassyID])}}" onclick="return confirm('Are you sure , you want to delete this attachment ? ')"><i class="fa fa-trash"></i>
                                                                Delete
                                                            </a>
                                        </td>
                                    </tr>
        ...
        <div class="modal-body">
            <form method="post" action="{{route('embassy.store')}}">@csrf
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" name="embassyName" aria-describedby="emailHelp" placeholder="Embassy Name">

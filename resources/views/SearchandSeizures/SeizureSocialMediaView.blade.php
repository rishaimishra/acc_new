      ...
      <div class = "col-12">
        <div class = "card">
          <div class = "card-header">
            <h2 class = "card-title text-info"><b>SEIZURES DETAILS FORM Social Media</b></h2>
            ...
            <form action="{{ route('saveSocialMediaAccount') }}" method="POST" enctype="multipart/form-data">
              @csrf
              ...
              <div class="row">
                ...
                <div class="col-md-4 form-group">
                  <input type="text" value='Social Media Account' class="form-control" name="itemtype" readonly>
                </div>
                {{-- <div class="col-md-4 form-group">
...
$(function () {
    ...
    $("#insertRow").on("click", function (event) {
        ...
        cols += '<td><input class="form-control rounded-0" type="text" name="platform[]" placeholder="Enter of Platform"></td>';
        cols += '<td><input class="form-control rounded-0" type="text" name="accountform[]" placeholder="Enter Account Name"></td>';

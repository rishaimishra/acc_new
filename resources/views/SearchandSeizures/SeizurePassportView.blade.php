      ...
      <div class = "col-12">
        <div class = "card">
          <div class = "card-header">
            <h2 class = "card-title text-info"><b>SEIZURES DETAILS FORM PASSPORT</b></h2>
            ...
            <form action="{{ route('saveSeizurePassport') }}" method="POST" enctype="multipart/form-data">
              @csrf
              ...
              <div class="row">
                ...
                <div class="col-md-4 form-group">
                  <input type="text" value='Passport' class="form-control" name="itemtype" readonly>
                </div>
                {{-- <div class="col-md-4 form-group">
...
$(function () {
    ...
    $("#insertRow").on("click", function (event) {
        ...
        cols += '<td><input class="form-control rounded-0" type="text" name="passportno[]" placeholder="Enter of Passport No"></td>';
        cols += '<td><input class="form-control rounded-0" type="text" name="name[]" placeholder="Enter Account Name"></td>';
        cols += '<td><input class="form-control rounded-0" type="text" name="issuedate[]" placeholder="Enter Issue Date"></td>';
        cols += '<td><input class="form-control rounded-0" type="text" name="expirydate[]" placeholder="Enter Expiry Date"></td>';
        cols += '<td><input class="form-control rounded-0" type="text" name="remarks[]" placeholder="Enter Remarks"></td>';

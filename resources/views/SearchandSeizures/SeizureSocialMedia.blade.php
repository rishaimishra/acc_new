      ...
      <div class = "col-12">
        ...
        <div class = "card">
          <div class = "card-header">
            <h2 class = "card-title text-info"><b>SEIZURES DETAILS - Social Media</b></h2>
          </div>
          ...
          <div class = "card-body">
              ...
              <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                  <div class="navbar-nav">
                    ...
                    <a class="nav-item nav-link active text-info text-light bg-info">Social media Accounts<span class="sr-only">(current)</span></a>
            ...
            <table id = "example3" class="table table-bordered table-hover ">
              ...
              <tbody>
                @foreach ( $Seizuresocialmedisaccount as $data )
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{route('viewSocialMediaDetails',$data->ssma_id) }}" class="btn btn-info btn-sm">Details</a>
                    </td>
                </tr>
                @endforeach
            ...
            <div class="col-md-4 justify-content-end">
              <a href="{{route('viewSocialMedia',$seizure_id) }}" class="btn btn-info btn-md text-white">Add New</a>
              </div> 
          </div>
        </div>
      </div>

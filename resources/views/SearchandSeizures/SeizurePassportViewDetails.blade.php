      ...
      <div class = "col-12">
        <div class = "card">
          <div class = "card-header">
            <h2 class = "card-title text-info"><b>SEIZURES DETAILS FOR PASSPORT</b></h2>
            ...
            <form action="" method="POST" enctype="multipart/form-data">
              @csrf
              @foreach ($Seizurepassport as $data)
              <div class="row">
                <div class="col-md-2">
                    <label>Case No:</label>
                </div>
              ...
              <div class="row">
                <div class="col-md-12">
                    <table class="table table-bordered container-fluid" id="table1s">
                        ...
                        <tbody>
                        @foreach ($Articleseizedpassport as $data1)
                          <tr>
                            <td>{{ $data1->passportno }}</td>
                            <td>{{ $data1->name }}</td>
                            <td>{{ $data1->issuedate }}</td>
                            <td>{{ $data1->expirydate }}</td>
                            <td>{{ $data1->remarks }}</td>

      ...
      <div class = "col-12">
        ...
        <div class = "card">
          <div class = "card-header">
            <h2 class = "card-title text-info"><b>Search Details - Director</b></h2>
          </div>
                ...
                <tr>
                  ...
                  <th>{{ ++$i }}</th>
                    ...
                    <td>
                      ...
                      @endif
                      <td>
                        <a href="{{route('DirectorUpdate', $data->seizure_id) }}" class="btn btn-info btn-sm text-white">Details</a>      
                      </td>
                </tr>
                @endforeach
              </tbody>

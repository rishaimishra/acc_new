          ...
          <div class = "col-12">
            <div class = "card">
              <div class = "card-header">
                  <h3 class= "card-title text-info"><b>Assigend Cases - Cheif</b></h3>
              </div>
                  ...
                  <table id = "example3" class="table table-bordered table-hover table-responsive">
                    ...
                    @foreach ($showcases as $product)
                     <tr>
                        ...
                        <td>{{ \Carbon\Carbon::parse($product->created_at)->format('d/m/Y')}}</td>
                        <td>
                          <a href="{{route('CheifSearchandSeizure', $product->id) }}" class="btn btn-xs btn-info">Search and Seizure Approval</a>
                      </td>
                    </tr>
                    @endforeach
                    </tbody>

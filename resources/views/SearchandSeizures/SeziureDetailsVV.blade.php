            ...
            <form action="{{ route('saveGeneral') }}" class="form" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-md-4 form-group">
                    <input type="text" value="{{ $case->case_no }}" class="form-control" name="case_no"  readonly>
                </div>
                ...
                <div class="col-md-4 form-group">
                    <input type="text" value="{{ $case->casetitle }}" class="form-control" name="case_title" readonly>
                </div>
                @endforeach
              </div>

              <div class="row">
                @foreach($mainarrestdata as $mainarrest)
                <div class="col-md-2">
                    <label>Search Warrant No:</label>
                </div>
                <div class="col-md-4 form-group">
                    <input type="text" class="form-control" value="{{ $mainarrest->warrantNo }}" name="searchwarrantNo" readonly>
                </div>
                ...
                <div class="col-md-4 form-group">
                    <input type="date" class="form-control" value="{{ $mainarrest->warrantDate }}" name="searchwarrantDate" readonly>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-md-4 form-group">
                    <input type="text" value="{{ $mainarrest->suspect }}" class="form-control" name="suspect" readonly>
                </div>
                ...
                <div class="col-md-4 form-group">
                    <input type="text" value="{{ $mainarrest->location }}" class="form-control" name="place" readonly>
                </div>
                @endforeach
              </div>
